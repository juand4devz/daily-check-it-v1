...
export function ModernLoading({ onComplete, duration = 3000 }: ModernLoadingProps) {
  ...
  }, [duration, onComplete, currentStep, steps.length])

  const CurrentIcon = steps[currentStep]?.icon || Loader2

  return (
    <div className="min-h-screen flex items-center justify-center bg-background ">
      <Card className="w-full max-w-xs mx-4 shadow-lg border-0 backdrop-blur-sm">
